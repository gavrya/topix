...
interface Module<A extends Action = AnyAction, S extends State = State, AT extends ActionTypes = ActionTypes, AC extends ActionCreators<A> = ActionCreators<A>, N extends string & keyof S = string & keyof S> {
    namespace: N;
    initialState: S[N];
    topics: Topic<A, S>[];
    actionTypes: AT;
...
export type { AnyObject, State, Action, AnyAction, ActionTypes, ActionCreators, Emit, TopicHandlerProps, TopicHandler, Topic, ObjectValuesUnion, ActionsFromActionCreators, Module, TopixProps, };
